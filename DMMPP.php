...
ob_start();
$HSON = "0000";
define('API_KEY',21238093);
echo file_get_contents("https://api.telegram.org/bot" . API_KEY . "/setwebhook?url=" . $_SERVER['سورس انستا'] . "" . $_SERVER['SCRIPT_NAME']);
...
//——————————————————//
$site = "smmatrixx.com"; 
$followers = "3000";  //متابعين//
$aboKrar = bot('getme',['AVFgRbot'])->result->username;  //معرف البوت//
$MTAWR = "a_ra_h";  //معرفك
$admin = "7114195996";  //ايديك//
include "DEVHSO.php";
//——————————————————//
